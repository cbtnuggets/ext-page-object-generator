...
class App extends React.Component {
    ...
    componentDidMount() {
      ...
      let currentStatus = window.localStorage.getItem('PAGE_OBJECT_STATUS')
    ...
    handleDeleteClick(e) {
      ...
      const rm = e.target.id.replace('delete-element-', '')
      ...
      chrome.tabs.query({currentWindow: true, active : true}, function(tabs){
        ...
        chrome.tabs.executeScript(null, {code:"var all = document.getElementsByTagName('*');\
          function inspectClick(e) {\
            e.stopPropagation();\
            e.preventDefault();\
            chrome.runtime.sendMessage({selector: UTILS.cssPath(e.target), putObject: true}, function(response) {console.log('Captured: ' + response.selector);});\
          }\
